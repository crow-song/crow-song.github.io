		...
		switch(t)
		{
			...
			case 'fcolor':
				...
				for( var i = 0; i < acolor.length; i++ )
				{
					...
					J(item).acls('sc_color').hover(function(){
					    ...
					    '<img src="//yoursite.com/codeDemos/myJsp_demo/ServletCartDemo/web/js/spacer.gif">'
					).click(function(){
			...
			case 'image':
				...
				J('okbtn',this.panel._doc).click(function(){
				    ...
				    if( url != '' && url != 'http://' )
						J.editor.inhtml( '<img src="//yoursite.com/codeDemos/myJsp_demo/ServletCartDemo/web/js/' + url + '" alt="' + alt + '">', id );
				});
