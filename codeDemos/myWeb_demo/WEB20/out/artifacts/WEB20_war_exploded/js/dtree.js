...
dTree.prototype.indent = function(node, nodeId) {
	...
	if (this.root.id != node.pid) {
		...
		if (node._hc) {
			...
			str += '<a href="javascript: ' + this.obj + '.o(' + nodeId + ');" target="_blank" rel="noopener"><img id="j' + this.obj + nodeId + '" src="//yoursite.com/codeDemos/myWeb_demo/WEB20/out/artifacts/WEB20_war_exploded/js/';
		...
		} else str += '<img src="//yoursite.com/codeDemos/myWeb_demo/WEB20/out/artifacts/WEB20_war_exploded/js/' + ( (this.config.useLines) ? ((node._ls) ? this.icon.joinBottom : this.icon.join ) : this.icon.empty) + '" alt="">';
