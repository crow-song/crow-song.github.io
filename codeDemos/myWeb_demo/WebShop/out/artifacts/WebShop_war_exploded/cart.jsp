...
<html>
	...
	<body>
		...
		<c:if test="${!empty cart.cartItems}">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/product?method=">
		...
		<c:if test="${empty cart.cartItems}">
			<div>
				<img alt="购物车为空" src="${pageContext.request.contextPath}/image/cart-empty.png" />
				<a href="${pageContext.request.contextPath}/">购物车为空，快去购物吧！</a>
			</div>
		</c:if>
		<!-- 引入footer.jsp -->
