...
<script type="text/javascript">
    ...
    $.validator.addMethod(
        //规则名称
        "checkUser",
        //value 文本框输入的值，element 被校验的元素对象，param 规则对应的参数值
      ...
      <form id="myform" class="form-horizontal" action="${pageContext.request.contextPath}/register" method="post"
        ...
        <div class="form-group opt">
          ...
          <div class="col-sm-6">
            ...
            <input type="radio" name="sex" id="sex2" value="fmale">女
          </label>
            <label class="error" for="sex" style="display:none">选择性别</label>
          </div>
        </div>
        <div class="form-group">
